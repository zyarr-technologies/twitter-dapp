...
function App() {
  ...
  const connectWallet = async () =>{
    ...
    console.log ("ConnectToWallet Called....................", provider, getnetwork)
    if(getnetwork.chainId != polygonChainId){
      warningNotification();
      try {
        console.log ("ConnectToWallet Called....................Switching to ChainId")
        ...
        console.log ("ConnectToWallet Called....................Some error")
        // This error code indicates that the chain has not been added to Metamask
        // So will add Polygon network to their metamask
        if(switchError.code === 4902){
          try{
            console.log ("ConnectToWallet Called....................Chain is not added")
            await provider.provider.request({
              ...
              params: [
                {
                  ...
                  rpcUrls : ["https://polygon-mumbai.g.alchemy.com/v2/gK3u9cuIOfiJinLfIQVOoy6SRljN2UHn"],
            ...
            console.log ("ConnectToWallet Called....................Some General Errors")
            throw addError;
          }
        }
